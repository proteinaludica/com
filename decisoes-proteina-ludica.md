...
**Rotas vivas:** `/`, `/criar` (rewrite para `/wizard-criar`), `/dr-escriba` (app Dr. Escriba IA v8.32, via `cleanUrls`), `/privacidade`, `/termos`, `/outputs/<plataforma>`, `/api/contact` (POST → email via Resend).
